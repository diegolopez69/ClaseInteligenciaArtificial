...
# Etiqueta: Categoría (1-> Tiene Diabetes
...
# Utilizar el método 'train_test_split' de la librería sklearn from sklearn.model_selection import train_test_split
...
# Visualizar el gráfico de la precisión de entrenamiento y test plt.title('k-NN para ''k'' vecinos')
...
# ERRORES/METRICAS
# Calcular la matriz de confusion (confusion matrix) # Para ver sobre el conjunto de test los resultados
# Importar el método
